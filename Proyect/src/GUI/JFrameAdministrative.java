...
public class JFrameAdministrative extends javax.swing.JFrame{
...
//    }
    ...
    private void initComponents() {
        ...
        JLTipeCateory = new javax.swing.JLabel();
        ...
        labelName.setBounds(130, 70, 60, 30);

        labelLastName.setText("Last Name");
        jPanelInsert.add(labelLastName);
        labelLastName.setBounds(120, 130, 80, 30);

        labelIdentification.setText("Identification");
        jPanelInsert.add(labelIdentification);
        labelIdentification.setBounds(120, 180, 80, 40);
        jPanelInsert.add(jTextFieldName);
        jTextFieldName.setBounds(200, 70, 140, 30);
        ...
        jTextFieldLastName.setBounds(200, 130, 140, 30);
        ...
        jTextFieldIdentification.setBounds(200, 190, 140, 28);
        ...
        JLTipeCateory.setText("Type Category");
        jPanelInsert.add(JLTipeCateory);
        JLTipeCateory.setBounds(120, 310, 80, 30);

        option1.setText("1");
        jPanelInsert.add(option1);
        option1.setBounds(220, 310, 50, 30);
        ...
        jLabelTimeWorked.setBounds(120, 250, 80, 20);
...
//            option1.setSelected(false);
        ...
        try {
             Administrative administrative = new Administrative(isQualified,
                Integer.parseInt(jTextFieldTimeWorked.getText()),
                jTextFieldName.getText(), jTextFieldLastName.getText(),
                Integer.parseInt(jTextFieldIdentification.getText()));
          
            SerializableAdministrative seriaAdmin = new SerializableAdministrative(Path.pathAdministative);
            seriaAdmin.serialize(administrative);
        } catch (IOException e) {
            Logger.getLogger(JFrameAdministrative.class.getName()).log(Level.SEVERE, null, e);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(JFrameAdministrative.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        }
    ...
    private javax.swing.JLabel JLTipeCateory;
